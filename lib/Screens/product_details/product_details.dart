            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                        color: ProductDetailsAppTheme.grey.withOpacity(0.2),
                          ...
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontSize: 22,
                                letterSpacing: 0.27,
                                color: ProductDetailsAppTheme.darkerText,
                              ),
                            ),
                          ),
                          Padding(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          fontSize: 22,
                                          letterSpacing: 0.27,
                                          color: ProductDetailsAppTheme.grey,
                                        ),
                                      ),
                                      Icon(
                                        Icons.star,
                                        color:
                                            ProductDetailsAppTheme.nearlyBlue,
                                        size: 24,
                                      ),
                                    ],
                                  ),
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        color:
                                            ProductDetailsAppTheme.nearlyWhite,
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: Icon(
                      ...
                      color: ProductDetailsAppTheme.nearlyBlack,
                    ),
                    onTap: () {
